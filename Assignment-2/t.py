...
(collection of word types) for the train corpus""")
   ...
   # print( smooth_bigram.getCorpusPerplexity(trainCorpus))
    ...
    print("Unigram positive test corpus: "+ str(posPerp))
    print("Unigram negative test corpus: "+ str(negPerp))
    
    posPerp = smooth_unigram.getCorpusPerplexity(posTestCorpus)
    negPerp = smooth_unigram.getCorpusPerplexity(negTestCorpus)   
    print("smooth_unigram positive test corpus: "+ str(posPerp))
    print("smooth_unigram negative test corpus: "+ str(negPerp))
    
    posPerp = bigram.getCorpusPerplexity(posTestCorpus)
    negPerp = bigram.getCorpusPerplexity(negTestCorpus)   
    print("bigram positive test corpus: "+ str(posPerp))
    print("bigram negative test corpus: "+ str(negPerp))