...
if __name__ == "__main__":
    ...
    perplexity_test1 = u.getCorpusPerplexity(posTestCorpus)
    perplexity_test2 = u.getCorpusPerplexity(negTestCorpus)
    ...
    perplexity_test1 = su.getCorpusPerplexity(posTestCorpus)
    perplexity_test2 = su.getCorpusPerplexity(negTestCorpus)
    print("Perplexity of positive test corpus: "+ str(perplexity_test1))
    print("Perplexity of negative test corpus: "+ str(perplexity_test2))
    # Bigram Model
    ...
    perplexity_test1 = b.getCorpusPerplexity(posTestCorpus)
    perplexity_test2 = b.getCorpusPerplexity(negTestCorpus)
    print("Perplexity of positive test corpus: "+ str(perplexity_test1))
    print("Perplexity of negative test corpus: "+ str(perplexity_test2))
    ...
    perplexity_test1 = sb.getCorpusPerplexity(posTestCorpus)
    perplexity_test2 = sb.getCorpusPerplexity(negTestCorpus)
    print("Perplexity of positive test corpus: "+ str(perplexity_test1))
    print("Perplexity of negative test corpus: "+ str(perplexity_test2))
